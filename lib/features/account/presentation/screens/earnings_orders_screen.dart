...
class EarningsOrdersScreen extends StatefulWidget {
  const EarningsOrdersScreen({super.key});

  @override
  State<EarningsOrdersScreen> createState() => _EarningsOrdersScreenState();
}

class _EarningsOrdersScreenState extends State<EarningsOrdersScreen> {
                  ...
                  children: [
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              const Icon(Icons.tag, color: Color(0xFF228B22), size: 18),
                              ...
                              Container(
                                ...
                                child: Icon(Icons.keyboard_arrow_down, color: Colors.grey[600], size: 18),
                              ),
                            ],
                          ),
                        ),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(8), borderSide: const BorderSide(color: Color(0xFF228B22), width: 1.5)),
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    // Order items - each in its own shadow box
                    ...List.generate(
                      3,
